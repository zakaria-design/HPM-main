            ...
            <div class="modal-body px-4" style="max-height: 60vh; overflow-y: auto;">
                @if($selectedSurat)
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-7">: {{ isset($selectedSurat->created_at) ? \Carbon\Carbon::parse($selectedSurat->update)->format('d-m-Y H:i') : '-' }}</div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-5 font-weight-bold">Status</div>
                        <div class="col-7 mb-2">: <span class="bg-success text-white px-2 py-1 rounded-lg">Success</span>
                        </div>
                    </div>
                @else
