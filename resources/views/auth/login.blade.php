...
<div class="login-card container py-5">
    <div class="row justify-content-center align-items-center">
        ...
        <div class="col-md-6 d-none d-md-block">
            <img src="{{ asset('logo.jpg') }}" alt="Login Image" class="img-fluid rounded">
        </div>
            ...
            <div class=" p-4">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="user_id" value="{{ old('user_id') }}" class="form-control" placeholder="Masukan ID">
                    </div>
